...
int handle_args(int argc, char * argv[]) {
	...
	args_option_t options[] = {
		...
		{'c', "code-address",        1, TYPE_ADDRESS, 0, args_address_callback,   .help=""}, // alias
		{0,   "exec-address",        1, TYPE_ADDRESS, 0, args_address_callback,   .help=""}, // alias
		{0,   "text-address",        1, TYPE_ADDRESS, 0, args_address_callback,   .help="set code memory address (MMU required)"},
